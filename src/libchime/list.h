...
bool u8_list_contains(uint8_t lst[], unsigned int key);

int u8_list_indexof(uint8_t lst[], unsigned int key);
...
bool u16_list_contains(uint16_t lst[], unsigned int key);

int u16_list_indexof(uint16_t lst[], unsigned int key);
...
bool ptr_list_contains(void * lst[], void * key);

int ptr_list_indexof(void * lst[], void * key);
